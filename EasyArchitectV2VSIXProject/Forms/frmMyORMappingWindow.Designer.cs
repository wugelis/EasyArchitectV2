namespace EasyArchitectV2VSIXProject.Forms
{
    partial class frmMyORMappingWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox1.Text = "EasyArchitect V2 Infrstructure Layer";
            // 
            // groupBox2
            // 
            ...
            this.labDesc.Text = "此精靈會產生 EasyArchitect V2 Framework 所需要的 Infrastructure 的類別庫專案，專案中會包含 Configuration" +
    "s、Persistance、Repository 與 DependencyInjections，透過資料庫中的實體 Table 來產生。";
            // 
            // txtLog
            // 
            ...
            this.Text = "EasyArchitect V2 Framework Infrastructure 產生器";
